...
%%%%% Choose DataSet
DataSet = 3;    % Use DataSet=1 for an example of how to process data for multiple cells from a single replicate
                % Use DataSet=2 for an example of how to process data for multiple cells from multiple replicates
data_struct = struct([]);

%%%%% Acquisition Parameters: 
TimeGap = 15; % delay between frames in milliseconds
...
elseif DataSet == 3
    data_struct(1).path = 'G:\Zelda\2017_10_24_Zld\his\fast\';
    data_struct(1).workspaces = {'1_MaxD5_Off1_spoton', '2_MaxD5_Off1_spoton', '3_MaxD5_Off1_spoton'};
    data_struct(1).Include=[1,2,3];
    SampleName = 'Test';
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
